...
import 'package:ustadia_user_app/features/learn/presentation/pages/learn_listening/learn_listening_lesson.dart';
...
class LearnListeningPageState extends State<LearnListeningPage> {
  ...
  /// --- Getters ---
  List<LearnQuizModel> get learnQuizModels => LearnQuizModel.listeningSampleQuestions;
